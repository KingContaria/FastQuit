...
public class ConfigScreen extends Screen {
    ...
    @Override
    public void init() {
        this.addDrawableChild(new ButtonWidget(this.width / 2 + 10, 55, 150, 20, TextHelper.onOrOff(FastQuit.showToasts), button -> button.setMessage(TextHelper.onOrOff(FastQuit.showToasts = !FastQuit.showToasts))));
        this.addDrawableChild(new ButtonWidget(this.width / 2 + 10, 85, 150, 20, TextHelper.onOrOff(FastQuit.renderSavingScreen), button -> button.setMessage(TextHelper.onOrOff(FastQuit.renderSavingScreen = !FastQuit.renderSavingScreen))));
        ...
        this.addDrawableChild(new ButtonWidget(this.width / 2 + 10, 145, 150, 20, getShowSavingTimeText(), button -> {
